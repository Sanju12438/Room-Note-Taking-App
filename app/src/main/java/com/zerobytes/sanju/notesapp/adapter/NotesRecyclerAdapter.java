package com.zerobytes.sanju.notesapp.adapter;
...
import com.zerobytes.sanju.notesapp.R;
import com.zerobytes.sanju.notesapp.models.Note;
import com.zerobytes.sanju.notesapp.util.Utility;
...
public class NotesRecyclerAdapter extends RecyclerView.Adapter<NotesRecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_notes_list_item_2, parent, false);
